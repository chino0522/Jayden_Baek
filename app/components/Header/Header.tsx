...
const Header = () => {
    ...
    const HeaderItem = ({ itemName, pathName }: HeaderItemProps) => {
        ...
        return (
            <div className={`${textColor} group relative my-2 mt-3 md:my-4 mx-3 px-4 py-2 md:px-10 flex items-center justify-center flex-grow-0 flex-shrink-0 cursor-pointer transition duration-300 ease-in-out w-24 md:w-32 text-center rounded-2xl overflow-hidden`}>
    ...
    return (
        <div className={`w-full h-full bg-white bg-opacity-95 text-center sticky top-0 z-10 flex flex-wrap content-evenly justify-evenly transition-transform duration-500 `}>
