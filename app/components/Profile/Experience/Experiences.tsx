...
const Experiences = () => {
  ...
  const ExperienceItem = ({ name, image, description, tech }: ExperienceItemProps) => {
    ...
    return (
      <div ref={ref} className={`w-72 md:w-96 h-auto rounded-xl bg-white shadow-lg border border-neutral-50 p-5 m-5 flex flex-col text-pretty transition-all hover:bg-neutral-100 hover:scale-105 duration-700 ${inView ? 'opacity-100' : 'opacity-20'}`}>
