    ...
    const ExperienceData = [
        {
            ...
            description: 'Community of Guardians is a non-profit organization that aims to provide a safe and inclusive space for people to connect and support each other. I am currently volunteering as a software developer for the organization.',
